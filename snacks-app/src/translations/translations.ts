export const translations = {
  no: {
    ...
    'ifcViewer.disclaimer': 'Alfa-versjon. Modellegenskaper vises kun til informasjon og er ikke kvalitetssikret.',
    'ifcViewer.background': 'Bakgrunn',
    'ifcViewer.backgroundLight': 'Lys',
    'ifcViewer.backgroundDark': 'Mørk',
    'ifcViewer.groupBy': 'Grupper etter',
    'ifcViewer.groupByElementName': 'Elementnavn',
    'ifcViewer.groupByEntity': 'Ifc Entity',
    'ifcViewer.noElementName': 'Uten elementnavn',
    'ifcViewer.resolvingElementNames': 'Leser elementnavn...',
    'ifcViewer.galleryTitle': 'IFC-modeller',
    'ifcViewer.galleryIntro': 'Velg en detaljmodell for å åpne den i IFC-visningen.',
    'ifcViewer.galleryOpen': 'Vis modell',
    'ifcViewer.galleryBack': 'Tilbake til modelloversikt',
    'ifcViewer.galleryThumbnailAlt': 'Forhåndsvisning av',
    'ifcViewer.galleryMissingThumbnail': 'Ingen forhåndsvisning',
    ...
    // Feedback
    'feedback.trigger': 'Gi tilbakemelding',
    'feedback.title': 'Gi tilbakemelding',
    'feedback.close': 'Lukk',
    'feedback.progressLabel': 'Steg i tilbakemeldingsskjemaet',
    'feedback.category.legend': 'Hva gjelder innspillet?',
    'feedback.category.question': 'Spørsmål',
    'feedback.category.improvement': 'Forbedringsforslag',
    'feedback.category.content_error': 'Feil i innhold',
    'feedback.category.technical_error': 'Teknisk feil på nettsiden',
    'feedback.category.other': 'Annet',
    'feedback.context.title': 'Kontekst fra siden',
    'feedback.context.page': 'Side',
    'feedback.context.help': 'URL, språk og SNACKS-versjon legges ved automatisk.',
    'feedback.publicNotice': 'Innspillet blir offentlig tilgjengelig som en GitHub-sak. Ikke del personopplysninger.',
    'feedback.next': 'Neste',
    'feedback.back': 'Tilbake',
    'feedback.description.label': 'Beskriv innspillet',
    'feedback.description.placeholder': 'Fortell oss hva du lurer på, eller hva du mener kan forbedres.',
    'feedback.submit': 'Send inn',
    'feedback.sending': 'Sender...',
    'feedback.success.title': 'Takk for innspillet!',
    'feedback.success.message': 'Innspillet er registrert som en offentlig GitHub-sak.',
    'feedback.success.reference': 'Se sak',
    'feedback.error.disabled': 'Tilbakemeldingsfunksjonen er midlertidig stengt.',
    'feedback.error.invalid_request': 'Kontroller at alle feltene er fylt ut og prøv igjen.',
    'feedback.error.challenge_failed': 'Sikkerhetskontrollen feilet. Prøv igjen.',
    'feedback.error.rate_limited': 'For mange innsendinger. Vent litt før du prøver igjen.',
    'feedback.error.duplicate_pending': 'Dette innspillet behandles allerede. Vent litt før du prøver igjen.',
    'feedback.error.configuration_error': 'Tilbakemeldingsfunksjonen er ikke ferdig konfigurert.',
    'feedback.error.upstream_error': 'Innspillet kunne ikke opprettes i GitHub. Prøv igjen senere.',
    'feedback.error.network_error': 'Nettverksfeil. Kontroller forbindelsen og prøv igjen.',
  ...
  en: {
    ...
    'ifcViewer.disclaimer': 'Alpha state. Model properties are shown for information only and have not been quality assured.',
    'ifcViewer.background': 'Background',
    'ifcViewer.backgroundLight': 'Light',
    'ifcViewer.backgroundDark': 'Dark',
    'ifcViewer.groupBy': 'Group by',
    'ifcViewer.groupByElementName': 'Element name',
    'ifcViewer.groupByEntity': 'Ifc Entity',
    'ifcViewer.noElementName': 'No element name',
    'ifcViewer.resolvingElementNames': 'Reading element names...',
    'ifcViewer.galleryTitle': 'IFC models',
    'ifcViewer.galleryIntro': 'Choose a detail model to open it in the IFC viewer.',
    'ifcViewer.galleryOpen': 'View model',
    'ifcViewer.galleryBack': 'Back to model overview',
    'ifcViewer.galleryThumbnailAlt': 'Preview of',
    'ifcViewer.galleryMissingThumbnail': 'No preview available',
    ...
    // Feedback
    'feedback.trigger': 'Give feedback',
    'feedback.title': 'Give feedback',
    'feedback.close': 'Close',
    'feedback.progressLabel': 'Feedback form progress',
    'feedback.category.legend': 'What is your feedback about?',
    'feedback.category.question': 'Question',
    'feedback.category.improvement': 'Improvement suggestion',
    'feedback.category.content_error': 'Content error',
    'feedback.category.technical_error': 'Technical website issue',
    'feedback.category.other': 'Other',
    'feedback.context.title': 'Page context',
    'feedback.context.page': 'Page',
    'feedback.context.help': 'The URL, language, and SNACKS version are included automatically.',
    'feedback.publicNotice': 'Your feedback becomes a public GitHub issue. Do not include personal information.',
    'feedback.next': 'Next',
    'feedback.back': 'Back',
    'feedback.description.label': 'Describe your feedback',
    'feedback.description.placeholder': 'Tell us what you are wondering about or what could be improved.',
    'feedback.submit': 'Submit',
    'feedback.sending': 'Submitting...',
    'feedback.success.title': 'Thank you for your feedback!',
    'feedback.success.message': 'Your feedback has been registered as a public GitHub issue.',
    'feedback.success.reference': 'View issue',
    'feedback.error.disabled': 'Feedback is temporarily unavailable.',
    'feedback.error.invalid_request': 'Check the form fields and try again.',
    'feedback.error.challenge_failed': 'The security check failed. Please try again.',
    'feedback.error.rate_limited': 'Too many submissions. Wait a while before trying again.',
    'feedback.error.duplicate_pending': 'This feedback is already being processed. Wait before trying again.',
    'feedback.error.configuration_error': 'Feedback has not been fully configured.',
    'feedback.error.upstream_error': 'The GitHub issue could not be created. Please try again later.',
    'feedback.error.network_error': 'Network error. Check your connection and try again.',
